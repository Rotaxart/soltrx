...
export class Base {
    ...
    static async _selectOrCreateTokenAccount(params) {
        ...
        if (associatedOnly) {
            createInfo.frontInstructions.push(Spl.makeCreateAssociatedTokenAccountInstruction({
                mint,
                associatedAccount: ata,
                owner,
            ...
            if (mint.equals(Token.WSOL.mint)) {
                ...
                const initAccountIns = Spl.createInitAccountInstruction(TOKEN_PROGRAM_ID, mint, newTokenAccount.publicKey, owner);
