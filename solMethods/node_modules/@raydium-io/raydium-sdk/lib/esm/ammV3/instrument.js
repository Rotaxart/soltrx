...
import { ASSOCIATED_TOKEN_PROGRAM_ID, METADATA_PROGRAM_ID, RENT_PROGRAM_ID, SYSTEM_PROGRAM_ID, TOKEN_PROGRAM_ID, } from "../common";
...
export function createPoolInstruction(programId, poolId, poolCreator, ammConfigId, observationId, mintA, mintVaultA, mintB, mintVaultB, sqrtPriceX64) {
...
export function increaseLiquidityInstruction(programId, positionNftOwner, positionNftAccount, personalPosition, poolId, protocolPosition, tickArrayLower, tickArrayUpper, ownerTokenAccountA, ownerTokenAccountB, mintVaultA, mintVaultB, liquidity, amountMaxA, amountMaxB) {
    const dataLayout = struct([
        u128("liquidity"),
        u64("amountMaxA"),
        u64("amountMaxB"),
...
export function decreaseLiquidityInstruction(programId, positionNftOwner, positionNftAccount, personalPosition, poolId, protocolPosition, tickArrayLower, tickArrayUpper, ownerTokenAccountA, ownerTokenAccountB, mintVaultA, mintVaultB, rewardAccounts, liquidity, amountMinA, amountMinB) {
    const dataLayout = struct([
        u128("liquidity"),
        u64("amountMinA"),
        u64("amountMinB"),
...
export function swapInstruction(programId, payer, poolId, ammConfigId, inputTokenAccount, outputTokenAccount, inputVault, outputVault, tickArray, observationId, amount, otherAmountThreshold, sqrtPriceLimitX64, isBaseInput) {
    const dataLayout = struct([
        u64("amount"),
...
export function initRewardInstruction(programId, payer, poolId, operationId, ammConfigId, ownerTokenAccount, rewardMint, rewardVault, openTime, endTime, emissionsPerSecondX64) {
    const dataLayout = struct([
        u64("openTime"),
        u64("endTime"),
...
export function setRewardInstruction(programId, payer, poolId, operationId, ammConfigId, ownerTokenAccount, rewardVault, rewardIndex, openTime, endTime, emissionsPerSecondX64) {
    const dataLayout = struct([
        u8("rewardIndex"),
        u128("emissionsPerSecondX64"),
        u64("openTime"),
...
export function collectRewardInstruction(programId, payer, poolId, ownerTokenAccount, rewardVault, rewardIndex) {
    const dataLayout = struct([
        u8("rewardIndex"),
    ]);
    const keys = [
