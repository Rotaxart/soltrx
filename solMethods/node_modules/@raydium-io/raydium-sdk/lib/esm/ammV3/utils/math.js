...
export class SwapMath {
    static swapCompute(programId, poolId, tickArrayCache, zeroForOne, fee, liquidity, currentTick, tickSpacing, currentSqrtPriceX64, amountSpecified, lastSavedTickArrayStartIndex, sqrtPriceLimitX64) {
        ...
        while (!state.amountSpecifiedRemaining.eq(ZERO) &&
            ...
            const { nextTick: nextInitTick, tickArrayAddress, tickArrayStartTickIndex: tickAarrayStartIndex } = TickQuery.nextInitializedTick(programId, poolId, tickArrayCache, state.tick, tickSpacing, zeroForOne);
