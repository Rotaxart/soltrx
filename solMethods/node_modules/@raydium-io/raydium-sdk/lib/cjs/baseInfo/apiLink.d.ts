...
export declare const RAYDIUM_MAINNET: {
    ...
    readonly ammV3Pools: "/v2/ammV3/ammPools";
    readonly ammV3Configs: "/v2/ammV3/ammConfigs";
    readonly ammV3PositionLine: "/v2/ammV3/positionLine/<poolId>";
};
export declare const RAYDIUM_DEVNET: {
    readonly time: "/v2/main/chain/time1111";
    readonly info: "/v2/main/info";
    readonly pairs: "/v2/main/pairs";
    readonly price: "/v2/main/price";
    readonly rpcs: "/v2/main/rpcs";
