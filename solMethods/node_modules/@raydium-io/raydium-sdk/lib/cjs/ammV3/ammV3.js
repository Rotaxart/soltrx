...
class AmmV3 extends base_1.Base {
    ...
    // transaction
    static makeCreatePoolInstructionSimple({ connection, programId, owner, mint1, mint2, ammConfig, initialPrice, computeBudgetConfig }) {
    ...
    static makeCreatePoolInstructions({ connection, programId, owner, mintA, mintB, ammConfigId, initialPriceX64 }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const instructions = [
                ...
                (0, instrument_2.createPoolInstruction)(programId, poolId, owner, ammConfigId, observationId.publicKey, mintA.mint, mintAVault, mintB.mint, mintBVault, initialPriceX64)
            ];
            return {
                address: {
