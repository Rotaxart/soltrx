...
function createPoolInstruction(programId, poolId, poolCreator, ammConfigId, observationId, mintA, mintVaultA, mintB, mintVaultB, sqrtPriceX64) {
    const dataLayout = (0, marshmallow_1.struct)([(0, marshmallow_1.u128)("sqrtPriceX64")]);
    const keys = [
