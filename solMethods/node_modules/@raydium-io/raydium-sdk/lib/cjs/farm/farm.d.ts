...
import { Base, InnerTransaction, InstructionType, TokenAccount, TxVersion } from "../base";
import { GetMultipleAccountsInfoConfig } from "../common";
...
export declare class Farm extends Base {
    ...
    static makeCreatorWithdrawFarmRewardInstructionSimple(params: FarmCreatorWithdrawRewardInstructionSimpleParams): Promise<{
        address: {};
        innerTransactions: {
            instructions: TransactionInstruction[];
            signers: any[];
    ...
    static makeCreatorWithdrawFarmRewardInstructionV6Simple({ connection, poolKeys, userKeys, withdrawMint, }: FarmCreatorWithdrawRewardInstructionSimpleParamsV6): Promise<{
        address: {};
        innerTransactions: {
            instructions: TransactionInstruction[];
            signers: any[];
    ...
    static makeCreateFarmInstructionSimple({ connection, userKeys, poolInfo }: makeCreateFarmInstructionSimpleParams): Promise<{
        address: {
            farmId: PublicKey;
        };
        innerTransactions: {
    ...
    static makeCreateFarmInstructionV6Simple({ connection, userKeys, poolInfo }: MakeCreateFarmInstructionParamsV6Simple): Promise<{
        address: {
            farmId: PublicKey;
        };
        innerTransactions: {
    ...
    static makeRestartFarmInstructionSimple(params: FarmRestartInstructionParams): Promise<{
        address: {};
        innerTransactions: {
            instructions: TransactionInstruction[];
            signers: Signer[];
    ...
    static makeRestartFarmInstructionV6Simple({ connection, poolKeys, userKeys, newRewardInfo, }: FarmRestartInstructionParamsV6): Promise<{
        address: {};
        innerTransactions: {
            instructions: TransactionInstruction[];
            signers: Signer[];
    ...
    static makeFarmCreatorAddRewardTokenInstructionSimple(params: FarmCreatorAddRewardTokenInstructionParams): Promise<{
        address: {};
        innerTransactions: {
            instructions: TransactionInstruction[];
            signers: Signer[];
    ...
    static makeFarmCreatorAddRewardTokenInstructionV6Simple({ connection, poolKeys, userKeys, newRewardInfo, }: FarmCreatorAddRewardTokenInstructionParamsV6): Promise<{
        address: {};
        innerTransactions: {
            instructions: TransactionInstruction[];
            signers: Signer[];
    ...
    static makeDepositInstructionSimple({ connection, poolKeys, fetchPoolInfo, ownerInfo, amount, associatedOnly }: {
        connection: Connection;
        poolKeys: FarmPoolKeys;
    ...
    static makeWithdrawInstructionSimple({ connection, fetchPoolInfo, ownerInfo, amount, associatedOnly }: {
        connection: Connection;
        fetchPoolInfo: FarmFetchMultipleInfoReturnItem;
        ownerInfo: {
            feePayer: PublicKey;
