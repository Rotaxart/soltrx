    ...
    static makeSwapInstruction({ routeProgram, ownerInfo, inputMint, swapInfo }) {
        if (swapInfo.routeType === 'amm') {
            ...
            return {
                ...
                innerTransaction: {
                    instructions: [
                        (0, instrument_2.route1Instruction)(routeProgram, poolKey1, poolKey2, ownerInfo.sourceToken, ownerInfo.routeToken, ownerInfo.userPdaAccount, ownerInfo.wallet, inputMint, swapInfo.amountIn.raw, swapInfo.minAmountOut.raw, swapInfo.remainingAccounts[0]),
                        (0, instrument_2.route2Instruction)(routeProgram, poolKey1, poolKey2, ownerInfo.routeToken, ownerInfo.destinationToken, ownerInfo.userPdaAccount, ownerInfo.wallet, swapInfo.middleMint, swapInfo.remainingAccounts[1])
                    ],
                    signers: [],
                    lookupTableAddress: [],
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (checkTransaction) {
                if ((0, common_1.forecastTransactionSize)(tempIns, [ownerInfo.wallet, ...tempSigner.map(i => i.publicKey)])) {
                    ...
                    if ((0, common_1.forecastTransactionSize)(ins.innerTransaction.instructions, [ownerInfo.wallet])) {
                        innerTransactions.push({
